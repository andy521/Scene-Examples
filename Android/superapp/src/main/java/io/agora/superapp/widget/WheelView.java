package io.agora.superapp.widget;
...
//                    Log.d(TAG, "remainder: " + remainder + ", divided: " + divided);
    ...
    private TextView createView(String item) {
        ...
        if (0 == itemHeight) {
            ...
            this.setLayoutParams(new LinearLayout.LayoutParams(lp != null ? lp.width : LayoutParams.MATCH_PARENT, itemHeight * displayItemCount));
        }
        return tv;
    }
