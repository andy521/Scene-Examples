...
public class RtcManager {
    ...
    private static final String AGORA_CDN_CHANNEL_PUSH_PREFIX = "rtmp://push.test1.agoramde.agoraio.cn/live/%s";
    private static final String AGORA_CDN_CHANNEL_PULL_PREFIX = "http://play2.test1.agoramde.agoraio.cn/live/%s.flv";
