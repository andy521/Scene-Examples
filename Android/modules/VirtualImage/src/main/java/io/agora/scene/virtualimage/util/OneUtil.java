...
import io.agora.scene.virtualimage.GlobalViewModelFactory;
...
public class OneUtil {
    ...
    public static int getBgdByRoomBgdId(@Nullable String bgdId) {
        ...
        switch (i) {
            case 1:
                return R.drawable.virtual_image_portrait01;
            case 2:
                return R.drawable.virtual_image_portrait02;
            case 3:
                return R.drawable.virtual_image_portrait03;
            case 4:
                return R.drawable.virtual_image_portrait04;
            case 5:
                return R.drawable.virtual_image_portrait05;
            case 6:
                return R.drawable.virtual_image_portrait06;
            case 7:
                return R.drawable.virtual_image_portrait07;
            case 8:
                return R.drawable.virtual_image_portrait08;
            case 9:
                return R.drawable.virtual_image_portrait09;
            case 10:
                return R.drawable.virtual_image_portrait10;
            case 11:
                return R.drawable.virtual_image_portrait11;
            case 12:
                return R.drawable.virtual_image_portrait12;
            case 13:
                return R.drawable.virtual_image_portrait13;
            default:
                return R.drawable.virtual_image_portrait14;
        }
    }
    ...
    public static void setBottomDialogBackground(@NonNull View view) {
        ...
        ShapeAppearanceModel shapeAppearanceModel = ShapeAppearanceModel.builder(view.getContext(),
                R.style.VirtualImagecornerNormalTopStyle, R.style.VirtualImagecornerNormalTopStyle).build();
