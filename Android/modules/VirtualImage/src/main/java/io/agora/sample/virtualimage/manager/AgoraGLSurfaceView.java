...
public class AgoraGLSurfaceView extends SurfaceView {
    ...
    private void initGLEnv(EglBase.Context sharedContext, Handler handler) {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(handler, () -> {
            try {
                mEglBase = null;
                if(!EglBase14.isEGL14Supported() || sharedContext != null && !(sharedContext instanceof io.agora.base.internal.video.EglBase14.Context)){
                    mEglBase = new EglBase10((io.agora.base.internal.video.EglBase10.Context)sharedContext, EglBase.CONFIG_PIXEL_BUFFER);
                }else{
                    mEglBase = new EglBase14((io.agora.base.internal.video.EglBase14.Context)sharedContext, EglBase.CONFIG_PIXEL_BUFFER);
                }
