...
import io.agora.scene.virtualimage.databinding.VirtualImageDialogGameListBinding;
...
import io.agora.scene.virtualimage.ui.room.RoomViewModel;
import io.agora.scene.virtualimage.util.OneUtil;

public class GameListDialog extends BaseBottomSheetDialogFragment<VirtualImageDialogGameListBinding> implements OnItemClickListener<AgoraGame>{
    ...
    private void initView() {
        ...
        BaseRecyclerViewAdapter<VirtualImageItemGameBinding, AgoraGame, ItemGameHolder> mAdapter = new BaseRecyclerViewAdapter<>(fetchAllGameList(), this, ItemGameHolder.class);
