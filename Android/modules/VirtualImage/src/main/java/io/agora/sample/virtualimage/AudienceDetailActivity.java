...
import io.agora.sample.virtualimage.databinding.VirtualImageAudienceDetailActivityBinding;
...
public class AudienceDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBinding = VirtualImageAudienceDetailActivityBinding.inflate(LayoutInflater.from(this));
