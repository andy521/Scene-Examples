...
public class GroupPhotoAvatarItemFragment extends BaseFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        avatarPTAS = DBHelper.create(getContext()).getAllAvatarP2As();
    ...
    class AvatarAdapter extends RecyclerView.Adapter<AvatarAdapter.HomeRecyclerHolder> {
        ...
        public HomeRecyclerHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new HomeRecyclerHolder(LayoutInflater.from(getContext()).inflate(R.layout.layout_delete_bottom_item, parent, false));
        }

        @Override
        public void onBindViewHolder(final HomeRecyclerHolder holder, int pos) {
