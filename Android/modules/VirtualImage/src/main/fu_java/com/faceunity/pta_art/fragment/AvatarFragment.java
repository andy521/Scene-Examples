...
public class AvatarFragment extends BaseFragment
    ...
    private void initView(View view) {
        ...
        mEditRecycler.setLayoutManager(mGridLayoutManager = new GridLayoutManager(requireActivity(), spanCount, GridLayoutManager.VERTICAL, false));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.avatar_bottom_item_delete:
                startActivity(new Intent(requireActivity(), AvatarPTADeleteActivity.class));
                break;
    ...
    class EditAdapter extends RecyclerView.Adapter<EditAdapter.EditHolder> {
        ...
        public EditHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new EditHolder(LayoutInflater.from(requireActivity()).inflate(R.layout.layout_avatar_bottom_item, parent, false));
        }
        ...
        public void onBindViewHolder(@NonNull EditHolder holder, int pos) {
            ...
            if (avatarP2A.getOriginPhotoRes() > 0) {
                ...
                Glide.with(requireContext()).load(new File(avatarP2A.getOriginPhoto())).
