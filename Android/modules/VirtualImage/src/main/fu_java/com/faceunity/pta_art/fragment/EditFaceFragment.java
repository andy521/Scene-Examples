...
public class EditFaceFragment extends BaseFragment
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mP2ACore.setNeedTrackFace(false);
        mAvatarHandle.clearExpression(mAvatarP2A, false);
    ...
    public void onBackPressed() {
        ...
        if (mFragmentLayout.getVisibility() == View.GONE && editFaceBaseFragment instanceof EditShapeFragment) {
            ...
            normalDialog.show(requireActivity().getSupportFragmentManager(), NormalDialog.TAG);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_model_reset:
                ...
                iv_model_redo_left.setEnabled(false);
                iv_model_redo_right.setEnabled(false);
                mAvatarP2A = mDefaultAvatarP2A.clone();
                mAvatarHandle.setAvatar(mAvatarP2A);
                resetUI();
    ...
    private void downHat(int pos) {
        workerHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    PTAClientWrapper.deformHairByServer(requireContext(), objData, hat.path, mAvatarP2A.getBundleDir() + hat.name);
                } catch (IOException e) {
                    e.printStackTrace();
                }
                requireActivity().runOnUiThread(new Runnable() {
    ...
    private void saveAvatar() {
        mLoadingDialog = new LoadingDialog.Builder(requireContext()).create();
        mLoadingDialog.show();
