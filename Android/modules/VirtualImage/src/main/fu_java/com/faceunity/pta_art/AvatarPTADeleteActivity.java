...
public class AvatarPTADeleteActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDBHelper = DBHelper.create(this);
    ...
    class AvatarP2ARecyclerAdapter extends RecyclerView.Adapter<AvatarP2ARecyclerAdapter.HomeRecyclerHolder> {
        ...
        public HomeRecyclerHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new HomeRecyclerHolder(LayoutInflater.from(AvatarPTADeleteActivity.this).inflate(R.layout.layout_delete_bottom_item, parent, false));
        }
