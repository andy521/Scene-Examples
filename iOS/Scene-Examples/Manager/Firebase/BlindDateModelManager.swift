    ...
    class FirebaseBlindDateModelManager: IBlindDateModelManager {
        ...
        func getAction(objectId: String) -> Observable<Result<BlindDateAction>> {
            return Database.query(className: BlindDateAction.TABLE, objectId: objectId) { (object: DocumentSnapshot) -> BlindDateAction in
                ...
                result.onSuccess { () -> Observable<Result<BlindDateAction>> in
        ...
        func getMember(by objectId: String) -> Observable<Result<BlindDateMember>> {
            return Database.query(className: BlindDateMember.TABLE, objectId: objectId) { (object: DocumentSnapshot) -> BlindDateMember in
                ...
                result.onSuccess { () -> Observable<Result<BlindDateMember>> in
        ...
        func create(room: BlindDateRoom) -> Observable<Result<String>> {
            return Database.save { () -> (String, data: [String: Any], String?) in
                (BlindDateRoom.TABLE, [BlindDateRoom.CHANNEL_NAME: room.channelName, BlindDateRoom.ANCHOR_ID: Database.document(table: User.TABLE, id: room.anchor.id)], nil)
            }
        }
        ...
        func getRooms() -> Observable<Result<[BlindDateRoom]>> {
            ...
            }.flatMap { (result: Result<[String]>) -> Observable<Result<[BlindDateRoom]>> in
                result.onSuccess { () -> Observable<Result<[BlindDateRoom]>> in
                    ...
                    if roomIds.count == 0 {
                        ...
                        }).map { (results: [Result<BlindDateRoom>]) -> Result<[BlindDateRoom]> in
        ...
        func update(room: BlindDateRoom) -> Observable<Result<String>> {
            return Database.save { () -> (String, data: [String: Any], String?) in
                (BlindDateRoom.TABLE, [BlindDateRoom.CHANNEL_NAME: room.channelName, BlindDateRoom.ANCHOR_ID: Database.document(table: User.TABLE, id: room.anchor.id)], room.id)
            }
        }
        ...
        func getMembers(room: BlindDateRoom) -> Observable<Result<[BlindDateMember]>> {
            ...
            }.flatMap { (result: Result<[String]>) -> Observable<Result<[BlindDateMember]>> in
                result.onSuccess { () -> Observable<Result<[BlindDateMember]>> in
                    ...
                    if memberIds.count == 0 {
                        ...
                        }).map { (results: [Result<BlindDateMember>]) -> Result<[BlindDateMember]> in
        ...
        func handsup(member: BlindDateMember) -> Observable<Result<Void>> {
            ...
            return Database.save { () -> (String, data: [String: Any], String?) in
                FirebaseBlindDateModelManager.toData(action: action)
            }
            .map { $0.transform() }
        }
