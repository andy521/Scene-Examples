...
- (void)setupUI {
    ...
    [[_imageView.leftAnchor constraintEqualToAnchor:self.contentView.leftAnchor  constant:2] setActive:YES];
    [[_imageView.rightAnchor constraintEqualToAnchor:self.contentView.rightAnchor constant:-2] setActive:YES];
    [[_imageView.topAnchor constraintEqualToAnchor:self.contentView.topAnchor constant:2] setActive:YES];
    [[_imageView.bottomAnchor constraintEqualToAnchor:self.contentView.bottomAnchor constant:-2] setActive:YES];
