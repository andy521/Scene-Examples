...
public class BlindDateMember {
    ...
    public func action(with action: BlindDateActionType) -> BlindDateAction {
        return BlindDateAction(id: "", action: action, status: .ing, member: self, room: room)
    }
}
...
extension BlindDateRoom {
    ...
    static func getRooms() -> Observable<Result<[BlindDateRoom]>> {
    ...
    func getMembers() -> Observable<Result<[BlindDateMember]>> {
        return BlindDateRoom.manager.getMembers(room: self)
    }

    func getCoverSpeakers() -> Observable<Result<[BlindDateMember]>> {
        return BlindDateRoom.manager.getCoverSpeakers(room: self)
    }

    func subscribeMembers() -> Observable<Result<[BlindDateMember]>> {
