    ...
    private func renderAvatars(speakers: Int, anchor: NSLayoutYAxisAnchor) {
        ...
        for index in 1 ... count {
            ...
            if _index < users.count {
                ...
                avatar.avatar.image = UIImage(named: users[_index].getLocalAvatar(), in: Utils.bundle, with: nil)
            } else {
                avatar.name.text = ""
                avatar.avatar.image = UIImage(named: "default", in: Utils.bundle, with: nil)
            }
...
//            }
    ...
    class AvatarView: UIView {
        var avatar: UIImageView = {
            ...
            view.color = nil
            view.borderWidth = 0
            view.image = UIImage(named: "default", in: Utils.bundle, with: nil)
            return view
        }()
    ...
    static func sizeForItem(room: PodcastRoom, width: CGFloat) -> CGSize {
        let count = CGFloat(room.speakersTotal <= 0 ? 1 : room.speakersTotal)
